    ...
    return (
      <div className='bg-white cursor-pointer w-56 h-80 rounded-lg shadow-md flex flex-col'>
        <figure className='relative mb-2 w-full h-4/5 rounded-t-lg overflow-hidden'>
          <img className='w-full h-full object-cover transition-transform duration-300 hover:scale-105' src={data.images[0]} alt={data.title} />
          ...
          <span className='absolute bottom-0 left-0 bg-white/70 rounded-b-lg text-black font-bold px-3 py-1'>{data.category.name}</span>
        </figure>
